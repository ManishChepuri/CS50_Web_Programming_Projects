...
- Four input fields to filter searches:
  ...
  - Any of these words
  - None of these words
- Left-aligned stacked input fields.
...
- CSS is styled to resemble Google’s aesthetics (centered inputs, rounded corners, consistent button styling).
